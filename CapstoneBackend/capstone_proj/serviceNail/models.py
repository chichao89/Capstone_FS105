...
class ServiceNail(models.Model):
   service_ID = models.IntegerField(verbose_name="Service ID", primary_key=True)
   ...
   service_description = models.CharField(verbose_name="Service Description", max_length=30)
